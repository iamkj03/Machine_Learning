...
train = pd.read_csv("export-EtherPrice.csv", header=None, usecols = [1,2])
...
with tf.Session() as sess:
    ...
    test_X = 1521417600/10000
    test_X = sc.fit_transform(test_X)
    test_Y = sess.run(W) * float(test_X) + sess.run(b)
    print('Prediction for March 19th(1521417600) is ')
    print(test_Y)
